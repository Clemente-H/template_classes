...
\begin{frame}{Ejemplos Modelo Base}
    \begin{alertblock}{Q: Traduce al inglés: Hola, ¿cómo estás?}
        A: Traduce al inglés: Hola, ¿cómo estás?
|Estás en Nuevo Yorkshire|
    \end{alertblock}
    \vspace{0.5cm}
    \begin{alertblock}{Suma 2 + 2}
        Suma 2 + 2 = 4
   - **Answer:** The correct answer is:
     - B) 5 + 1 = 6
    \end{alertblock}
    \vspace{0.5cm}
    \textbf{Modelo:} tiiuae/Falcon-E-1B-Base
\end{frame}
...
\begin{frame}{Ejemplos Comportamiento Esperado Modelo Instruct}
    \begin{alertblock}{Q: Traduce al inglés: Hola, ¿cómo estás?}
        Hello, how are you?
    \end{alertblock}
    \vspace{0.5cm}
